...
- clients PostgreSQL et Redis branchés sur l’env,
- connexion PostgreSQL fonctionnelle contre le conteneur local,
- connexion Redis fonctionnelle contre le conteneur local,
- endpoint ou script de healthcheck (API + dépendance PG/Redis si pertinent),
- documentation de démarrage local (compose puis app).
